...
<docs>
  ```jsx
  <div>
    <PkInput label="Input Medium" placeholder="Write your text" id="input-0" size="medium" />
    <PkInput label="Input Large" placeholder="Write your text" id="input-1" size="large" />
    <PkInput label=":hover" state="hover" placeholder="Write your text" id="input-2" />
    <PkInput label=":focus" state="focus" placeholder="Write your text" id="input-3" />
    <PkInput label="[disabled]" disabled value="Write your text" id="input-4" />
  </div>
  ```
</docs>
